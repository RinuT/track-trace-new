...
angular.module('myApp.manufacturer', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/manufacturer', {
    templateUrl: 'manufacturer/manufacturer.html',
    controller: 'manufacturerCtrl'
  });
}])

.controller('manufacturerCtrl', ['$scope','$http','$timeout',function ($scope,$http,$timeout) {
